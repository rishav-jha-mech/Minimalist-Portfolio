    ...
    <ScreenWrapper animateSplash={false} animateNavbar={false}>
      <section className={styles.container}>
        <div className={styles.left}>
          <h1>About Me</h1>
          <p>
            Beginning my educational journey at St. Stephen&rsquo;s School in
            Dum Dum, Kolkata, I pursued the Science stream, laying the
            groundwork for my future endeavors. Transitioning to higher
            education, I enrolled at NIT Durgapur to pursue a Bachelor&rsquo;s
            degree in Mechanical Engineering.
            <br />
            <br />
            During my time at NIT Durgapur, I embarked on a journey into the
            world of technology. In my first year, I started exploring full
            stack development. As I progressed into my sophomore year, I
            ventured into creating complex applications using React Native,
            alongside Django and Flask for backend development. Throughout the
            remainder of my college years, I continued to expand my skill set,
            delving into technologies such as Devops, Flutter, and more.
            <br />
            <br />I am currently working as a <strong>
              Game Developer
            </strong> at <strong>Cuemath !</strong>
          </p>
        </div>
