			...
			<section className={styles.container}>
				...
				<div className={styles.right}>
					...
					<p>
						...
						refining the nuances of UI/UX design, each endeavor becomes a canvas for boundless creativity
						and innovation. With a knack for problem-solving, I navigate through challenges, crafting
						solutions that sparkle with simplicity and elegance
					</p>
